...
### CH2: Subiz có tự động lưu SĐT hoặc Email trong tin nhắn của khách không?
...
### CH3: Xuất file danh sách khách về được không?
...
### CH 7:Xem địa chỉ IP của khách như thế nào?
...
### CH 8:Chặn khách trên Subiz như thế nào?
...
### CH 10:Tìm lại hội thoại đã ẩn do chặn khách bằng cách nào?
