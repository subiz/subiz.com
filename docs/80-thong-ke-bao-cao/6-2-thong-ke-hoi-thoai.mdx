...
:::tip
Sau khi hội thoại thay đổi Tag, hệ thống sẽ cập nhật kết quả thống kê theo Tag <b>trong vòng 24 giờ</b>. Nếu cần xem thống kê ngay sau khi đổi Tag, bạn có thể xuất toàn bộ hội thoại và lọc dữ liệu trên Google Sheet.
:::
