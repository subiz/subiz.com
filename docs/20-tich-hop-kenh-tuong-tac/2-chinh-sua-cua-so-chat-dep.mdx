...
<b>Hướng dẫn chỉnh sửa cửa sổ chat</b>: 
...
## Cách thay đổi ảnh nút chat {#cach-thay-doi-anh-nut-chat}
...
## Cách thay đổi kích thước dài, rộng của cửa sổ chat {#cach-thay-doi-kich-thuoc-dai-rong-cua-cua-so-chat}
...
## Cài đặt bắt buộc khách điền thông tin trước khi chat {#cai-dat-bat-buoc-khach-dien-thong-tin-truoc-khi-chat}
...
## Bảng hỏi thông tin khách hàng khi nhân viên ngoại tuyến? {#bang-hoi-thong-tin-khach-hang-khi-nhan-vien-ngoai-tuyen}
