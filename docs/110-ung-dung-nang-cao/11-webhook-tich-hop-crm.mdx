...
:::tip
Trong gói tin có rất nhiều dữ liệu liên quan tới sự kiện bạn quan tâm. Hãy thử tạo 1 sự kiện và khám phá nhé.
:::
