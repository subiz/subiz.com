...
### Ví dụ mã API sửa tiêu đề, lời chào  {#vi-du-ma-api-sua-tieu-de-loi-chao}
...
### Ví dụ API sửa màu nền cửa sổ chat, tên tiêu đề, lời chào {#vi-du-api-sua-mau-nen-cua-so-chat-ten-tieu-de-loi-chao}
...
### Ví dụ API tắt lời chào  {#vi-du-api-tat-loi-chao}
...
### Ví dụ API tắt bảng hỏi thông tin {#vi-du-api-tat-bang-hoi-thong-tin}
...
### Ví dụ API tắt nút chat Subiz  {#vi-du-api-tat-nut-chat-subiz}
...
### Ví dụ API thay đổi hình ảnh nút chat {#vi-du-api-thay-doi-hinh-anh-nut-chat}
...
### Ví dụ API thay đổi nút chat, lời chào và tiêu đề {#vi-du-api-thay-doi-nut-chat-loi-chao-va-tieu-de}
