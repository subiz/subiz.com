...
## Đồng bộ thông tin khách từ vào Subiz {#dong-bo-thong-tin-khach-tu-vao-subiz}


Bạn muốn đồng bộ thông tin khách vào Subiz hoặc khách đăng nhập website sẽ hiện thông tin trên Subiz. Bạn sẽ dùng mã SDK dưới đây ra lệnh chuyển thông tin khách về Subiz: 
```
<script>
