...
### Bước 1: Quản lý danh sách website {#buoc-1-quan-ly-danh-sach-website}
...
 
### Bước 2: Thêm Agent phụ trách từng website {#buoc-2-them-agent-phu-trach-tung-website}
...
![](https://vcdn.subiz-cdn.com/file/fismoidujgszkesthcrt_acpxkgumifuoofoosble/9d9770f22721d9ca59589288c64abdaa.png)

### Bước 3: Cài cửa sổ chat cho website đầu tiên {#buoc-3-cai-cua-so-chat-cho-website-dau-tien}
...
![](https://vcdn.subiz-cdn.com/file/fismoidvfcsisyjmsjwa_acpxkgumifuoofoosble/ce5abea32561e4e8b24d1046fa53dee8.png)

### Bước 4: Cài đặt API sửa cửa sổ chat cho các website khác {#buoc-4-cai-dat-api-sua-cua-so-chat-cho-cac-website-khac}
...
<b>Ví dụ mã API sửa tiêu đề, lời chào hiển thị tên/ ảnh thương hiệu</b>
...
<b>Ví dụ API sửa màu cửa sổ chat, tiêu đề, lời chào</b>
...
<b>Ví dụ API thay đổi nút chat</b>
```
<script>
subiz('overrideChatbox', {
  chatbox: {
...
<b>Ví dụ API sửa tiêu đề và lời chào</b>
```
<script>
  subiz('overrideChatbox', {
    type: 'chatbox',
...
### Bước 5: Phân phối khách hàng theo từng website {#buoc-5-phan-phoi-khach-hang-theo-tung-website}
...
### Bước 6: Bot tự động trả lời theo từng website {#buoc-6-bot-tu-dong-tra-loi-theo-tung-website}
...
### Bước 7: Thống kê hội thoại của mỗi website {#buoc-7-thong-ke-hoi-thoai-cua-moi-website}
