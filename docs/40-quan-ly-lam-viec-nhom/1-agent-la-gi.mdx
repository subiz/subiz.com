...
## Xử lý tình huống thường gặp {#xu-ly-tinh-huong-thuong-gap}

### CH1: Cách xử lý khi agent quên mật khẩu đăng nhập Subiz {#ch1-cach-xu-ly-khi-agent-quen-mat-khau-dang-nhap-subiz}
...
### CH2: Cách thay đổi email của agent {#ch2-cach-thay-doi-email-cua-agent}
...
### CH 3: Cách thay đổi họ tên và agent đại diện của agent? {#ch-3-cach-thay-doi-ho-ten-va-agent-dai-dien-cua-agent}
...
### CH4: Cách thay đổi email chủ sở hữu tài khoản {#ch4-cach-thay-doi-email-chu-so-huu-tai-khoan}
...
### CH5: Cách xóa agent trên Subiz {#ch5-cach-xoa-agent-tren-subiz}
...
### CH6: Cách cài đặt agent giám sát viên {#ch6-cach-cai-dat-agent-giam-sat-vien}
...
### CH7: Tại sao agent mới không xem được hội thoại cũ của khách? {#ch7-tai-sao-agent-moi-khong-xem-duoc-hoi-thoai-cu-cua-khach}
...
### CH8: Cách tự động chia hội thoại cho agent trả lời khách hàng {#ch8-cach-tu-dong-chia-hoi-thoai-cho-agent-tra-loi-khach-hang}
...
### CH9: Cách agent đổi ngôn ngữ trên trang app Subiz {#ch9-cach-agent-doi-ngon-ngu-tren-trang-app-subiz}
...
### CH10. Cách đăng xuất tài khoản Subiz {#ch10-cach-dang-xuat-tai-khoan-subiz}
...
### CH11: Cách xử lý khi agent nhận thông báo “Bạn không có quyền xem khách này?” {#ch11-cach-xu-ly-khi-agent-nhan-thong-bao-ban-khong-co-quyen-xem-khach-nay}
...
### CH12: Sự khác nhau giữa agent thành viên hội thoại và agent phụ trách khách hàng?  {#ch12-su-khac-nhau-giua-agent-thanh-vien-hoi-thoai-va-agent-phu-trach-khach-hang}
